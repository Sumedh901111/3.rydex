                                ...
                                <div>
                                    {step == "login" && (
                                        ...
                                        >
                                            ...
                                            <div className='mt-6 text-center text-sm text-gray-500'> Don’t have an account? <div onClick={() => setStep("signup")} className='text-black font-medium hover:underline'>Sign Up</div></div>
